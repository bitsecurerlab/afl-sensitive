                    ...
                    abi_long arg8)
{
    ...
    switch(num) {
    case TARGET_NR_exit: //cgcos _terminate()
    ...
    //     break;
    case 4: //cgcos_fdwait(int nfds, fd_set __user *readfds, fd_set __user *writefds, struct timeval __user *timeout, int __user *readyfds)
    ...
    //     break;
    case 5: //cgcos_allocate(unsigned long len, unsigned long exec, void __user **addr)
    {
    ...
    //     break;
    case 6: //cgcos_deallocate()= sys_munmap()
...
//         break;
    case 2: //cgcos_transmit(int fd, char __user * buf, size_t count, size_t __user *tx_bytes)
    {
...
//         break;
// #endif
    case 7: //cgcos_random(char __user * buf, size_t count, size_t __user *rnd_out) 
    {
        if(arg2 < 0)
          goto efault;
        size_t i, size;
