 ...
 reswitch:
    ...
    case 0xff: /* GRP5 */
        ...
        do_lcall:
            if (s->pe && !s->vm86) {
                ...
                gen_helper_update_calling_context(tcg_const_tl(s->pc - pc_start));
                ...
                gen_helper_update_calling_context(tcg_const_tl(s->pc - s->cs_base));
    ...
    do_lret:
        if (s->pe && !s->vm86) {
            ...
            gen_helper_restore_calling_context(tcg_const_tl(pc_start - s->cs_base));
