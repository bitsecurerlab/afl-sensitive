...
static inline void gen_op_ld_v(DisasContext *s, int idx, TCGv t0, TCGv a0)
{
    ...
    // TCGv pc = tcg_const_tl(s->pc);
    // gen_helper_log_mem_access(pc, a0);
    // tcg_temp_free(pc);
...
static inline void gen_goto_tb(DisasContext *s, int tb_num, target_ulong eip)
{
    ...
    if ((pc & TARGET_PAGE_MASK) == (tb->pc & TARGET_PAGE_MASK) ||
        ...
        // gen_helper_maybe_log(tcg_const_tl(eip), tcg_const_tl(cur_pc));
                           ...
                           target_ulong val, target_ulong next_eip)
{
    ...
    if (s->jmp_opt) {
        ...
        gen_helper_maybe_log(tcg_const_tl(next_eip), tcg_const_tl(cur_pc));

        gen_goto_tb(s, 0, next_eip);

        gen_set_label(l1);

        gen_helper_maybe_log(tcg_const_tl(val), tcg_const_tl(cur_pc));
...
static void gen_eob(DisasContext *s)
{
    ...
    if (s->singlestep_enabled) {
        ...
        // tcg_gen_ld_tl(tmpTo, cpu_env, offsetof(CPUX86State, eip));

        // gen_helper_maybe_log(tmpTo, tcg_const_tl(cur_pc));
 ...
 reswitch:
    ...
    case 0xff: /* GRP5 */
        ...
        case 2: /* call Ev */
            ...
            gen_helper_update_calling_context(cpu_T[1]);
            
            gen_op_jmp_v(cpu_T[0]);

            gen_helper_maybe_log(cpu_T[0], tcg_const_tl(cur_pc));
        ...
        do_lcall:
            if (s->pe && !s->vm86) {
                gen_update_cc_op(s);
                gen_helper_update_calling_context(tcg_const_i32(s->pc - pc_start));
                gen_jmp_im(pc_start - s->cs_base);
                tcg_gen_trunc_tl_i32(cpu_tmp2_i32, cpu_T[0]);
                ...
                tcg_gen_trunc_tl_i32(cpu_tmp2_i32, cpu_T[0]);
                gen_helper_update_calling_context(tcg_const_i32(s->pc - s->cs_base));
                gen_helper_lcall_real(cpu_env, cpu_tmp2_i32, cpu_T[1],
                                      tcg_const_i32(dflag - 1),
                                      tcg_const_i32(s->pc - s->cs_base));
            }

            TCGv tmpTo_1 = tcg_temp_new();
            tcg_gen_ld_tl(tmpTo_1, cpu_env, offsetof(CPUX86State, eip));

            gen_helper_maybe_log(tmpTo_1, tcg_const_tl(cur_pc));

            tcg_temp_free(tmpTo_1);
        ...
        do_ljmp:
            ...
            TCGv tmpTo_2 = tcg_temp_new();
            tcg_gen_ld_tl(tmpTo_2, cpu_env, offsetof(CPUX86State, eip));
            gen_helper_maybe_log(tmpTo_2, tcg_const_tl(cur_pc));
            tcg_temp_free(tmpTo_2);
    ...
    case 0xc2: /* ret im */
        ...
        gen_helper_restore_calling_context(cpu_T[0]);
    ...
    do_lret:
        if (s->pe && !s->vm86) {
            gen_update_cc_op(s);
            gen_helper_restore_calling_context(tcg_const_i32(pc_start - s->cs_base));
            gen_jmp_im(pc_start - s->cs_base);
    ...
    case 0xe8: /* call im */
        {
            ...
            gen_push_v(s, cpu_T[0]);
            gen_helper_update_calling_context(cpu_T[0]);
            gen_jmp(s, tval);
        }
        break;
    case 0x9a: /* lcall im */
