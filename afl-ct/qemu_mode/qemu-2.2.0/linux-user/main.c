...
struct image_info global_shadow_image_info;
...
int main(int argc, char **argv, char **envp)
{
    ...
    struct image_info *info = &global_shadow_image_info;
    /* Zero out image_info */
...
# endif
    ...
    if (qemu_log_enabled()) {
        ...
        qemu_log("mmap        0x" TARGET_ABI_FMT_lx "\n", info->mmap);
        qemu_log("start_mmap  0x" TARGET_ABI_FMT_lx "\n", info->start_mmap);
        qemu_log("data_offset 0x" TARGET_ABI_FMT_lx "\n", info->data_offset);
    }
