...
static inline void gen_op_ld_v(DisasContext *s, int idx, TCGv t0, TCGv a0)
{
    ...
    // gen_helper_log_mem_access(pc, a0, tcg_const_i32(0));
...
{
    TCGv pc = tcg_const_tl(s->pc);
    // gen_helper_log_mem_access(pc, a0, tcg_const_i32(1));
    ...
    case 0xff: /* GRP5 */
        ...
        do_lcall:
            if (s->pe && !s->vm86) {
                ...
                // gen_helper_update_calling_context(tcg_const_i32(pc_start - s->cs_base));
